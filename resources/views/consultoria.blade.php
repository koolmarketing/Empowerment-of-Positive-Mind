	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 text-center col-md-offset-2 pv-20">
				<h2 class="title object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">CONSULTORIA EMPRESARIAL Y EMPODERAMIENTO</h2>
					...
					<div class="row grid-space-0">
						<div class="col-md-6">
							<div class="overlay-container">
								<img src="img/compl/competencias.jpg" alt="" class="img-responsive">
						...
						<div class="col-md-6">
							<div class="body">
								...
								<h3>CONDUCIR PROCESOS DE RECLUTAMIENTO Y SELECCIÓN DE PERSONAL POR COMPETENCIAS.</h3>
				...
				<div class="image-box style-4">
					<div class="row grid-space-0">
						...
						<div class="col-md-6">
							<div class="body">
								<div class="pv-30 visible-lg"></div>
								<h3>COMUNICACIÓN, RELACIONES INTERPERSONALES Y CLIMA
					...
					<div class="image-box style-4">
						<div class="row grid-space-0">
							<div class="col-md-6 col-md-push-6">
								<div class="overlay-container">
									<img src="img/compl/valores.jpg" alt="" class="img-responsive">
									<div class="overlay-to-top">
										<p class="small margin-clear"><em>Some info <br> Lorem ipsum dolor sit</em></p>
									</div>
								</div>
					...
					<div class="image-box style-4">
						<div class="row grid-space-0">
							<div class="col-md-6">
								<div class="overlay-container">
									<img src="img/compl/familia_v.jpg" alt="">
									<div class="overlay-to-top">
										<p class="small margin-clear"><em>Some info <br> Lorem ipsum dolor sit</em></p>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="body">
									<div class="pv-30 visible-lg"></div>
									<h3>CALIDAD DE VIDA EN LA ORGANIZACIÓN Y EN LA FAMILIA QUINCENALMENTE.</h3>
										<div class="separator-2"></div>
										<p class="margin-clear">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihialal. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam laudantium, provident culpa saepe.</p>
										<br>
						...
						<div class="image-box style-4">
							<div class="row grid-space-0">
								<div class="col-md-6 col-md-push-6">
									<div class="overlay-container">
										<img src="img/compl/salario_emocional.jpg" alt="" class="img-responsive">
										<div class="overlay-to-top">
											<p class="small margin-clear"><em>Some info <br> Lorem ipsum dolor sit</em></p>
										</div>
									</div>
								...
								<div class="col-md-6 col-md-pull-6">
									<div class="body text-right">
										<div class="pv-30 visible-lg"></div>
										<h3>ORGANIZACIÓN Y DISEÑO DEL SALARIO EMOCIONAL</h3>
										<div class="separator-3"></div>
										<p class="margin-clear">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihialal. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam laudantium, provident culpa saepe.</p>
										<br>
